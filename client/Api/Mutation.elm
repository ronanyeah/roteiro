...
module Api.Mutation exposing (AuthenticateUserRequiredArguments, ChangePasswordRequiredArguments, CreatePositionRequiredArguments, CreateSubmissionRequiredArguments, CreateTagRequiredArguments, CreateTopicRequiredArguments, CreateTransitionRequiredArguments, DeletePositionRequiredArguments, DeleteSubmissionRequiredArguments, DeleteTagRequiredArguments, DeleteTopicRequiredArguments, DeleteTransitionRequiredArguments, SignUpUserRequiredArguments, UpdatePositionRequiredArguments, UpdateSubmissionRequiredArguments, UpdateTagRequiredArguments, UpdateTopicRequiredArguments, UpdateTransitionRequiredArguments, authenticateUser, changePassword, createPosition, createSubmission, createTag, createTopic, createTransition, deletePosition, deleteSubmission, deleteTag, deleteTopic, deleteTransition, selection, signUpUser, updatePosition, updateSubmission, updateTag, updateTopic, updateTransition)
