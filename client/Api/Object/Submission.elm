...
module Api.Object.Submission exposing (PositionOptionalArguments, TagsOptionalArguments, UserOptionalArguments, createdAt, id, name, notes, position, selection, steps, tags, updatedAt, user)
...
{-| -}
createdAt : Field Api.Scalar.DateTime Api.Object.Submission
createdAt =
    Object.fieldDecoder "createdAt" [] (Object.scalarDecoder |> Decode.map Api.Scalar.DateTime)


{-| -}
updatedAt : Field Api.Scalar.DateTime Api.Object.Submission
updatedAt =
...
{-| -}
steps : Field (Maybe (List String)) Api.Object.Submission
steps =
    Object.fieldDecoder "steps" [] (Decode.string |> Decode.list |> Decode.nullable)


{-| -}
notes : Field (Maybe (List String)) Api.Object.Submission
notes =
    Object.fieldDecoder "notes" [] (Decode.string |> Decode.list |> Decode.nullable)


type alias PositionOptionalArguments =
...
-}
position : (PositionOptionalArguments -> PositionOptionalArguments) -> SelectionSet decodesTo Api.Object.Position -> Field decodesTo Api.Object.Submission
position fillInOptionals object_ =
    let
        filledInOptionals =
    ...
    in
    Object.selectionField "position" optionalArgs object_ identity
...
-}
tags : (TagsOptionalArguments -> TagsOptionalArguments) -> SelectionSet decodesTo Api.Object.Tag -> Field (Maybe (List decodesTo)) Api.Object.Submission
...
-}
user : (UserOptionalArguments -> UserOptionalArguments) -> SelectionSet decodesTo Api.Object.User -> Field decodesTo Api.Object.Submission
