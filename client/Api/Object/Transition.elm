...
startPosition fillInOptionals object =
    let
        filledInOptionals =
    ...
    in
    Object.selectionField "startPosition" optionalArgs object identity
...
endPosition fillInOptionals object =
    let
        filledInOptionals =
            fillInOptionals { where_ = Absent }
        ...
        optionalArgs =
            [ Argument.optional "where" filledInOptionals.where_ Api.InputObject.encodePositionWhereInput ]
                |> List.filterMap identity
    in
    Object.selectionField "endPosition" optionalArgs object identity
