...
module Api.Enum.TransitionOrderByInput exposing (TransitionOrderByInput(..), decoder, toString)
        ...
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid TransitionOrderByInput type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )
